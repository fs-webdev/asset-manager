...
/**
 * Sort an array of paths so that they will be in a breath first order (least number of
 ...
 * breathFirstPathSort(paths); // => ['reference/node_modules/myRepo', 'reference/node_modules/theme-engage/node_modulesmyRepo'];
 */
var nodeModulesRegex = /node_modules/g;
exports.breathFirstPathSort = function(paths, order) {
  if (order === 'desc') {
