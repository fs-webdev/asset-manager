...
function appendLocaleStrings(baseLocalePath, localeFileName) {
  ...
  // at some point, the beginning of this function will be obselete, and lang
  // in the function below will be coming from TAAS
  contents += "function i18n(key) {\n";
  contents += "  var lang = $.extend({}, langs['en'], l1);\n\n";
  contents += "  key = key.split('.');\n";
  contents += "  var translation = lang;\n";
  contents += "  var i = 0;\n";
  contents += "  var l = key.length;\n";
  contents += "  for(i; i < l; i++) {\n";
  contents += "    translation = translation[key[i]];\n";
  contents += "  }\n";
  contents += "  return translation\n";
  contents += "}\n\n";
