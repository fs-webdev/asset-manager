...
proto.setContent = function setContent(newContent, type, skipMangle, minifyCSS) {
  ...
  if(compressCSS && type === 'css') {
    // console.log('css this',this);
    
    // console.log('proto.setContent.caller:',proto.setContent.caller);
    console.log('this.meta.mainFile',this.meta.mainFile);
    this.contentRaw = this.content.toString('utf8');
    if(this.ext === 'styl' && !minifyCSS) {
      console.log('stylus file no compressy:', this.meta.mainFile, this.content.toString('utf8'));
      this.content = this.contentRaw;
    }
    else {
      try {
        // console.log('try compressCSSraw', this.meta.mainFile, this.contentRaw);
        this.content = utils.compressCSS(this.content.toString('utf8'), compressCSSConfig);
        // console.log('try compressCSSmin', this.meta.mainFile, this.content);
        // console.log('Try compressCSS');
      } catch (e) {
        // console.error("Error compressing file '" + this.meta.mainFile + ":" + e.message);
        this.content = this.contentRaw;
        // console.log('error compressCSS', this.meta.mainFile, this.content);
      }
    }
  }
};
